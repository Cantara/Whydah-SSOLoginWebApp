            ...
            <table id="profile">
                 ...
                 <tr/>
                  <tr>
                       ...
                       <td> ${CRMcustomer!"No referenced customer found or no Whydah CRMService configured"}   <br/><br/>       <a href="/oidsso/crmdata?personRef=${personRef!"1234"}" title="Edit my CRM Customer date">Edit CRM-Profile</a>
 </td>
                  <tr/>
                  <tr>
